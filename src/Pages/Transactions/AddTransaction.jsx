  ...
  const handleSaveTransaction = () => {
    ...
    if (transactionType === "transfer") {
      ...
      updatedAccounts = updatedAccounts
        .map((acc) =>
          acc.name === fromAccount
            ? { ...acc, balance: acc.balance - numericAmount }
            : acc
        )
        .map((acc) =>
          acc.name === toAccount
      ...
      const transactionAmount =
        transactionType === "income" ? numericAmount : -numericAmount;
      ...
      updatedAccounts = updatedAccounts.map((acc) =>
        acc.name === selectedAccount
          ? { ...acc, balance: acc.balance + transactionAmount }
          : acc
      );
    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <main className="flex flex-col items-center gap-5 max-w-sm w-full">
          <motion.div
            className="relative flex w-full rounded-3xl p-1"
            style={{ backgroundColor: "var(--primary)" }}
          >
            <motion.div
          ...
          {transactionType === "transfer" ? (
            <>
              <select
                required
                className="w-full p-3 rounded-lg shadow-md bg-white text-lg"
                style={{
            ...
            <>
              <input
                ...
                className="w-full p-3 rounded-lg shadow-md text-lg"
                style={{
                  backgroundColor: "var(--on-background)",
                  color: "var(--on-primary)",
                }}
          ...
          <input
            ...
            className="date w-full p-3 rounded-xl shadow-md text-lg"
            value={date}
