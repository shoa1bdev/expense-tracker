...
const AddAccountModal = ({ setAccounts, setIsAdding, pastelColors }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-opacity-60 backdrop-blur-sm" style={{ backgroundColor: "rgba(0, 0, 0, 0.6)" }}>
      <div className="p-6 rounded-lg shadow-lg w-4/5 max-w-md relative transition-all duration-300" style={{ backgroundColor: "var(--primary)", color: "var(--onBackground)" }}>
        ...
        <input
          ...
          style={{ borderColor: errors.name ? "var(--error)" : "var(--onBackground)", backgroundColor: "var(--onPrimary)", color: "var(--onBackground)" }}
        ...
        <input
          ...
          className="border p-2 rounded w-full mb-2"
          style={{ borderColor: errors.balance ? "var(--error)" : "var(--onBackground)", backgroundColor: "var(--onPrimary)", color: "var(--onBackground)" }}
          placeholder="Balance"
        />
        ...
        <select
          ...
          style={{ backgroundColor: "var(--onPrimary)", color: "var(--onBackground)", borderColor: "var(--onBackground)" }}
        >
